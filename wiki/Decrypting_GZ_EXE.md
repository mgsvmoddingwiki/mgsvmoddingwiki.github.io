...
Ground Zeroes EXE is encrypted with [SteamStub DRM](https://partner.steamgames.com/doc/features/drm);
since game code is encrypted, analysis is impossible (the only functions you will see in the encrypted EXE in Ghidra are from SteamStub).
