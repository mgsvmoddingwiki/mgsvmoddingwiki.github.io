...
> This is only relevant since longer build times means more waiting for changes to appear on the wiki in the past some issues with longer running Github workflows.
