...
> Want to just edit an existing page? [Click here](#editing-an-existing-page) to jump to the steps.
{:.tip}

> A downside to this method is new images can't be added and you're limited to changing one file at a time. If you need that check out the [Using Github Desktop](/Meta/Creating_Editing_Pages/Using_Github_Desktop) or [Using Github.com](/Meta/Creating_Editing_Pages/Using_Github_com) guide.
{:.note}
...
> If you're not comfortable authorizing Prose.io for this you can alternatively follow the [Using Github.com](/Meta/Creating_Editing_Pages/Using_Github_com/) guide.
{:.tip}
...
> You can always revoke authorization to Prose.io later if you'd like by visiting [this](https://github.com/settings/applications) Github setting page. 
{:.tip}
...
> Also check out the source of existing wiki pages for inspiration by clicking the circular *Page Source* button in the toolbar at the top of every wiki page.
{:.tip}
...
> There's also a Preview button there but it doesn't accurately reflect how the page will look since the wiki uses a special kind of Markdown and also various custom styling.
{:.note}
...
> This section assumes you've already authorized Prose.io for your Github account. If you haven't yet follow [these steps](#authorizing-proseio-for-your-account) first.
{:.important}
