...
First is to run [Version Tracking](/Ghidra_version_tracking/) to match functions from debug exe to prod exe. That was already done before - this
...
## See also
  - [Ghidra version tracking](/Ghidra_version_tracking)
